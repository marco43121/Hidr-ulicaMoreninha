...
export default function ReparoHidraulico() {
 const [itens,setItens]=useState([]);
 useEffect(()=>{
   fetch("/api/galeria/reparo-hidraulico").then(r=>r.json()).then(setItens).catch(()=>setItens([]));
 },[]);
 return (
 ...
 <h1 style={{fontSize:"3rem",color:"#ffd700"}}>Reparo Hidráulico</h1>
