...
export default function RodasRolamentos() {
 const [itens,setItens]=useState([]);
 useEffect(()=>{
   fetch("/api/galeria/rodas-rolamentos").then(r=>r.json()).then(setItens).catch(()=>setItens([]));
 },[]);
 return (
 ...
 <h1 style={{fontSize:"3rem",color:"#ffd700"}}>Rodas e Rolamentos</h1>
